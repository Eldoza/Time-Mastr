...
describe 'overtime calculations' do
  it 'calculates accurate overtime for salaried employees' do
  ...
  it 'returns 0 for an overtime amount if the total hours are under 40' do
    forty_or_under = SalariedOvertimeCalculator.calculate weekly_salary: 1000.0, total_hours: 40.0
    expect(forty_or_under).to eq(0)
  end
end
